...
module mam_optics_constants
  ...
  integer, parameter :: kNumberOfChebyshevCoefficients = 5
  integer, parameter :: kNumberOfShortwaveBands        = 14
  integer, parameter :: kNumberOfLongwaveBands         = 16

  ! Shortwave and longwave spectral bounds (cm-1)
  real(r8), parameter :: shortwave_lower( kNumberOfShortwaveBands ) =         &
  ...
  real(r8), parameter :: shortwave_upper( kNumberOfShortwaveBands ) =         &
